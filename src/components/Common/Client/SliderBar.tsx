...
>
      ...
      {!isCollapsed ? (
        <div className="mt-auto w-full">
          <div className="p-2">
            <div className="flex items-center space-x-3">
              <img src={girl} alt="Playlist" className="h-32 w-32 rounded-md" />
        ...
        <div className="mt-auto mb-2 w-full">
          <div className="p-3">
            <div className="border-2 p-2 rounded-full border-zinc-300">
              ...
              <img src={girl} alt="Playlist" className="h-9 w-9 rounded-full" />
            </div>
          </div>
        </div>
      )}
