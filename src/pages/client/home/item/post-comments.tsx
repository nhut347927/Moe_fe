  ...
  return (
    <div className="space-y-6 pb-32">
      ...
      <div className="pt-10 mt-10 border-t">
              ...
              <div key={comment.commentCode} className="space-y-3">
                <div className="flex gap-3">
                  <Avatar className="h-9 w-9">
                      <AvatarImage src={`https://res.cloudinary.com/dwv76nhoy/image/upload/w_80,h_80,c_thumb,f_auto,q_auto/${comment.userAvatar}`} />
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-black/90 mt-0.5">
                      {comment.content}
                    </p>
                    ...
                    <div className="flex justify-between gap-4 text-xs text-muted-foreground mt-1">
                      ...
                      <div className="flex items-center me-4 gap-1 text-xs text-muted-foreground">
                        {!comment?.liked ? (
                          <Heart
                            onClick={() =>
                            ...
                            <div key={reply.commentCode}>
                              <div className="flex gap-2">
                                <Avatar className="h-7 w-7">
                                   <AvatarImage src={`https://res.cloudinary.com/dwv76nhoy/image/upload/w_80,h_80,c_thumb,f_auto,q_auto/${reply.userAvatar}`} />
                                  <AvatarFallback>
                                    {reply.displayName[0]}
                                  </AvatarFallback>
                                </Avatar>
                                <div className="flex-1">
                                  ...
                                  <div className="flex justify-between gap-4 text-xs text-muted-foreground mt-1">
                                    ...
                                    <span className="flex items-center me-4 gap-1">
                                      {!reply?.liked ? (
                                        <Heart
                                          onClick={() =>
                                            handleLikeOrUnlike(
        ...
        <div
          className={`transition-all duration-500 ease-in-out mt-8 sticky bottom-0 ${
            isFullscreen
              ? "pb-4"
              : "pb-[5px] sm:pb-[env(safe-area-inset-bottom)]"
          } backdrop-blur-sm pt-4 pb-2 -mx-4 px-4 border-t`}
        >
          {replyTarget && (
